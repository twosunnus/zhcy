...
DishesTypeInfo dishesTypeInfoBean = (DishesTypeInfo)request.getAttribute("dishesTypeInfoBean");
%>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td valign="top" background="<%=basePath %>pc/images/content-bg.gif"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">类别修改</div></td>
      </tr>
    </table></td>
  ...
  <tr>
	...
	<td valign="top" bgcolor="#F7F8F9">
		<input type="hidden" name="ji_id" value="<%=dishesTypeInfoBean.getDti_id() %>">
	  <table width="40%" align="center" border="0" cellpadding="0" cellspacing="0" class="table_bordel0">
		<tr align="center">
			...
			<td>
				<input type="text" name="dti_name" value="<%=dishesTypeInfoBean.getDti_name() %>">
			</td>
		</tr>
		<tr>
