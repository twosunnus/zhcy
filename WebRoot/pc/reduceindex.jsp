...
H1 a {
	...
	background-image: url(./pc/images/menu_bgs.gif);
...
.MM a:link {
	...
	line-height: 26px;
	color: #333333;
	background-image: url(./pc/images/menu_bg1.gif);
...
.MM a:hover {
	...
	font-weight: bold;
	color: #006600;
	background-image: url(./pc/images/menu_bg2.gif);
	background-repeat: no-repeat;
	text-align: center;
	display: block;
	margin: 0px;
...
<div id="container">
      <h1 class="type"><a href="javascript:void(0)">邮箱管理</a></h1>
      <div class="content">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><img src="./pc/images/menu_topline.gif" width="182" height="5" /></td>
          </tr>
        </table>
        <ul class="MM">
          <li><a href="http://www.865171.cn" target="main">写邮件</a></li>
          <li><a href="http://www.865171.cn" target="main">收件箱</a></li>
          <li><a href="http://www.865171.cn" target="main">发件箱</a></li>
          <li><a href="http://www.865171.cn" target="main">草稿箱</a></li>
